...
function scoreboard(getInningScoreCB, inningCallback, inningsPlayed) {
  let scoresArray = [];
  let homeScore = 0;
  let awayScore = 0;
  for (let i = 0; i < inningsPlayed; i++) {
    let currentScore = getInningScoreCB(inningCallback);
    homeScore = homeScore + currentScore.Home
    awayScore = awayScore + currentScore.Away
    scoresArray.push(`Inning ${i}: Away ${currentScore.Away} - Home ${currentScore.Home}`)
  }
